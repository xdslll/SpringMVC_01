...
<table id="dg" title="供应商列表" class="easyui-datagrid" style="width:100%;height:550px;"
       data-options="
                url: '<%=request.getContextPath()%>/supplier/get',
                method: 'get',
                idField: 'id',
                showFooter: true,
                fitColumns: true,
    ...
    <thead>
    <tr>
        <th data-options="field:'code'" width="20%">供应商编码</th>
