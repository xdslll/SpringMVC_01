...
<table id="dg" title="部门列表" class="easyui-datagrid" style="width:100%;height:500px;"
       data-options="
    ...
    <thead>
    <tr>
        <th data-options="field:'code'" width="20%">部门编号</th>
        <th data-options="field:'name'" width="20%">部门名称</th>
