...
<table id="dg" title="竞争对手列表" class="easyui-datagrid" style="width:100%;height:550px;"
       data-options="
                url: '<%=request.getContextPath()%>/competitor/get',
                method: 'get',
                idField: 'id',
                showFooter: true,
                fitColumns: true,
    ...
    <thead>
    <tr>
        <th data-options="field:'name'" width="50%">竞争门店</th>
        <th data-options="field:'cityName'" width="50%">所在城市</th>
    </tr>
    </thead>
</table>
