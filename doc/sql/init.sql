...
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (4,'数据分析','open',0,'');
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (5,'预警管理','open',0,'');
...
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (13,'市调日志记录','open',1,'');
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (21,'商品数据导入','open',2,'/import');
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (22,'门店数据导入','open',2,'/import/dept');
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (23,'市调人员导入','open',2,'');
...
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (35,'日志管理','open',6,'');
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (41,'商品价格趋势分析','open',4,'');
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (42,'实时商品价格比对','open',4,'');
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (43,'竞争门店价格趋势分析','open',4,'');
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (44,'价格综合比对','open',4,'');
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (51,'预警策略管理','open',5,'');
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (52,'预警下发管理','open',5,'');
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (53,'预警历史记录','open',5,'');
...
INSERT INTO `enford_system_menu` (`id`,`text`,`state`,`parent`,`url`) VALUES (315,'市调人员管理','open',3,'');
